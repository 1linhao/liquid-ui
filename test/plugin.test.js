...
test('Vue adapter installs only public LiquidUI components', () => {
  ...
  assert.deepEqual([...registered.keys()].sort(), [
    'LiquidButton', 'LiquidDatePicker', 'LiquidDialog', 'LiquidDropdown', 'LiquidForm', 'LiquidFormItem', 'LiquidGlassSurface', 'LiquidInput', 'LiquidNumberInput', 'LiquidPopover', 'LiquidSelect', 'LiquidSwitch', 'LiquidTag', 'LiquidTooltip'
  ])
