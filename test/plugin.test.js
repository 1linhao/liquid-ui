...
test('Vue adapter installs only public LiquidUI components', () => {
  ...
  assert.deepEqual([...registered.keys()].sort(), [
    'LiquidButton', 'LiquidDatePicker', 'LiquidDialog', 'LiquidForm', 'LiquidFormItem', 'LiquidGlassSurface', 'LiquidInput', 'LiquidNumberInput', 'LiquidSelect', 'LiquidSwitch', 'LiquidTag'
  ])
